...
<html>
   ...
   <body>
      ...
      <header>
         ...
         <nav>
            <ul class="menu">
               ...
               <li class="menu-items menu-active"><a href="#" >Liên Hệ</a></li>
            </ul>
         </nav>
      ...
      <!-- Start Container -->
      <section>
         <h1 class="contact-text">Liên hệ với chúng tôi</h1>

         <div class="container">
            <div class="items">
               <div class="avt"> <img src="../../asset/picture/avt-admin/3581f0b2845c6b02324d.jpg" alt="" ></div>
               <div class="desc">
                  <h1 class="name">Võ Duy Long</h1>
                  <ul class="media-list">
                     <li><a href="https://www.facebook.com/voduylong.0611" target="_blank">
                     ...
                     <li><a href="https://www.instagram.com/long.vdl/" target="_blank">
                  ...
                  <ul class="social-network">
                     ...
                     <li><a href="#">
                        ...
                        <p>voduylong1106@gmail.com</p>
                     </a></li>
                  </ul>
               </div>
            </div>
            <div class="empty">
               Hi, I'm Vo Duy Long <br>
               I'm interested in Frond End, Data Science <br>
               I'm currently learning QNU <br>
               Im looking to collaborate on Github
            </div>
            <div class="empty">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, accusamus sequi, tempora dolores commodi nobis, molestiae non nihil et placeat sit ad quidem! Nihil ea harum distinctio voluptatum quasi pariatur!
            </div>
            <div class="items">
               <div class="avt">
                  <img src="../../asset/picture/avt-admin/voduongduytruc.jpg" alt="">
               </div>
               <div class="desc">
                  <h1 class="name">võ dương duy trực</h1>
                  <ul class="media-list">
                     <li><a href="https://www.facebook.com/DuyTruc2" target="_blank">
                        <i class="fa-brands fa-facebook-f"></i>
                        <p>Facebook</p>
                     </a></li>
                     <li><a href="https://www.facebook.com/DuyTruc2" target="_blank">
            ...
            <div class="empty">
               <!-- Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid, architecto consequatur. Quasi sit harum aut, repudiandae necessitatibus molestias eius error labore amet modi doloribus ad id, porro quidem ut nostrum? -->
            </div>
            <div class="empty">
               <!-- Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perferendis facere illum animi, vel rerum mollitia deleniti debitis officiis sapiente vitae, repellat et accusantium eius. Expedita iusto iure mollitia tempore laboriosam? -->
            </div>
            
            <div class="items">
               <div class="avt">
                  <img src="../../asset/picture/avt-admin/vutanthi.jpg" alt="">
               </div>
               <div class="desc">
                  <h1 class="name">Vũ Tấn Thi</h1>
                  <ul class="media-list">
                     <li><a href="https://www.facebook.com/profile.php?id=100078826920463" target="_blank">
                        <i class="fa-brands fa-facebook-f"></i>
                        <p>Facebook</p>
                     </a></li>
                     <li><a href="https://www.facebook.com/profile.php?id=100078826920463" target="_blank">
            ...
            <div class="empty">
               Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima praesentium totam non quasi porro, nostrum obcaecati repudiandae nulla, autem similique veniam quisquam, quo velit doloremque odio quod tempore omnis? Quam.
            </div>
            <div class="empty">
               Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam minus voluptates libero ducimus facilis asperiores laboriosam amet quia nihil sequi. Ipsum labore accusamus non est iusto incidunt odio at reprehenderit!
            </div>
            <div class="items">
               <div class="avt"><img src="../../asset/picture/avt-admin/nguyenvanhoa.jpg" alt=""></div>
               <div class="desc">
                  <h1 class="name">Nguyễn Văn hòa</h1>
                  <ul class="media-list">
                     <li><a href="https://www.facebook.com/profile.php?id=100034950189755" target="_blank">
                        <i class="fa-brands fa-facebook-f"></i>
                        <p>Facebook</p>
                     </a></li>
                     <li><a href="https://www.facebook.com/profile.php?id=100034950189755" target="_blank">
                  ...
                  <ul class="social-network">
                     ...
                     <li><a href="">
                        <i class="fa-solid fa-envelope"></i>
                        <p>nguyenvanhoa26062001@gmail.com</p>
                     </a></li>
                  </ul>
               </div>
            </div>
            <div class="items">
               <div class="avt">
                  <img src="../../asset/picture/avt-admin/nguyenxuanhai.jpg" alt="">
               </div>
               <div class="desc">
                  <h1 class="name">Nguyễn Xuân hải</h1>
                  <ul class="media-list">
                     <li><a href="https://www.facebook.com/profile.php?id=100010273538686" target="_blank">
                        <i class="fa-brands fa-facebook-f"></i>
                        <p>Facebook</p>
                     </a></li>
                     <li><a href="https://www.facebook.com/profile.php?id=100010273538686" target="_blank">
                  ...
                  <ul class="social-network">
                     ...
                     <li><a href="">
                        <i class="fa-solid fa-envelope"></i>
                        <p>nguyexuanhai7755@gmail.com</p>
                     </a></li>
                  </ul>
               </div>
            </div>
