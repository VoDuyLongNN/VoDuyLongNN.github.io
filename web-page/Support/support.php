...
<html>
   ...
   <body>
      ...
      <header>
         ...
         <nav>
            <ul class="menu">
               ...
               <li class="menu-items menu-active"><a href="#" >Hỗ Trợ</a></li>
      ...
      <div class="support-banner">
         <img src="../../asset/picture/product/banner-brand/support_banner.webp" alt="">
      </div>
      <!-- End Banner Support -->

      <!-- Start Support Products -->
      <div class="support-products">
         <ul>
            <li class="list-items"><div class="item-icon js-item-icon-phone">
               <img src="https://img.icons8.com/ios/50/000000/phonelink-ring--v2.png"/>
               <a href="" class="product-name">Điện Thoại</a>
            </div></li>
            <li class="list-items"><div class="item-icon js-item-icon-laptop">
               <img src="https://img.icons8.com/ios/50/000000/laptop--v1.png"/>
               <a href="" class="product-name">Laptop</a>
            </div></li>
            <li class="list-items"><div class="item-icon js-item-icon-pc">
               <img src="https://img.icons8.com/external-prettycons-lineal-prettycons/49/000000/external-pc-screen-devices-prettycons-lineal-prettycons.png"/>
               <a href="" class="product-name">Màn Hình</a>
            </div></li>
            <li class="list-items"><div class="item-icon js-item-icon-mouse">
               <img src="https://img.icons8.com/ios/50/000000/generic-mouse.png"/>
               <a href="" class="product-name">Chuột</a>
            </div></li>
            <li class="list-items"><div class="item-icon js-item-icon-keyboard">
               <img src="https://img.icons8.com/ios/50/000000/keyboard.png"/>
               <a href="" class="product-name">Bàn Phím Cơ</a>
            </div></li>
            <li class="list-items"><div class="item-icon js-item-icon-headphone">
               <img src="https://img.icons8.com/external-flatart-icons-outline-flatarticons/64/000000/external-headphone-modern-business-and-business-essentials-flatart-icons-outline-flatarticons.png"/>
               <a href="" class="product-name">Tai Nghe</a>
            </div></li>
         </ul>
      </div>

      <!-- Start Support Product Form Model-->
         <!-- Phone -->
         <div class="support-form phone-support-form js-phone-support-form">
            <div class="container">
               <div class="close-form-support js-close-form-support-phone"><i class="fa-solid fa-xmark"></i></div>
               <h2 class="title">Chúng tôi sẽ hỗ trợ bạn</h2>
               <div class="details">
                  <p>Chi tiết Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste atque magni neque quam a sequi, quos eaque deleniti delectus repudiandae vel dolorum quasi dolorem eius, laudantium quisquam architecto. Quia, eveniet.
                  </p>
               </div>
               <div class="support-link">
                  <a href="">Link <i class="fa-solid fa-chevron-right"></i></a>
                  <a href="">Link <i class="fa-solid fa-chevron-right"></i></a>
                  <a href="">Link <i class="fa-solid fa-chevron-right"></i></a>
               </div>
            </div>
         ...
         <!-- Laptop -->
         <div class="support-form laptop-support-form js-laptop-support-form">
            <div class="container">
               <div class="close-form-support js-close-form-support-laptop"><i class="fa-solid fa-xmark"></i></div>
               <h2 class="title">Chúng tôi sẽ hỗ trợ bạn</h2>
               <div class="details">
                  <p>Chi tiết Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste atque magni neque quam a sequi, quos eaque deleniti delectus repudiandae vel dolorum quasi dolorem eius, laudantium quisquam architecto. Quia, eveniet.</p>
            </div>
            <div class="support-link">
               <a href="">Link <i class="fa-solid fa-chevron-right"></i></a>
               <a href="">Link <i class="fa-solid fa-chevron-right"></i></a>
         ...
         <!-- Pc -->
         <div class="support-form pc-support-form js-pc-support-form">
            <div class="container">
               <div class="close-form-support js-close-form-support-pc"><i class="fa-solid fa-xmark"></i></div>
               <h2 class="title">Chúng tôi sẽ hỗ trợ bạn</h2>
               <div class="details">
                  <p>Chi tiết Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste atque magni neque quam a sequi, quos eaque deleniti delectus repudiandae vel dolorum quasi dolorem eius, laudantium quisquam architecto. Quia, eveniet.</p>
            </div>
         ...
         <!-- Mouse -->
         <div class="support-form mouse-support-form js-mouse-support-form">
            <div class="container">
               <div class="close-form-support js-close-form-support-mouse"><i class="fa-solid fa-xmark"></i></div>
               <h2 class="title">Chúng tôi sẽ hỗ trợ bạn</h2>
               <div class="details">
                  <p>Chi tiết Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste atque magni neque quam a sequi, quos eaque deleniti delectus repudiandae vel dolorum quasi dolorem eius, laudantium quisquam architecto. Quia, eveniet.</p>
            </div>
         ...
         <!-- Keyboard -->
         <div class="support-form keyboard-support-form js-keyboard-support-form">
            <div class="container">
               <div class="close-form-support js-close-form-support-keyboard"><i class="fa-solid fa-xmark"></i></div>
               <h2 class="title">Chúng tôi sẽ hỗ trợ bạn</h2>
               <div class="details">
                  <p>Chi tiết Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste atque magni neque quam a sequi, quos eaque deleniti delectus repudiandae vel dolorum quasi dolorem eius, laudantium quisquam architecto. Quia, eveniet.</p>
            </div>
         ...
         <!-- Headphone -->
         <div class="support-form headphone-support-form js-headphone-support-form">
            <div class="container">
               <div class="close-form-support js-close-form-support-headphone"><i class="fa-solid fa-xmark"></i></div>
               <h2 class="title">Chúng tôi sẽ hỗ trợ bạn</h2>
               <div class="details">
                  <p>Chi tiết Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste atque magni neque quam a sequi, quos eaque deleniti delectus repudiandae vel dolorum quasi dolorem eius, laudantium quisquam architecto. Quia, eveniet.</p>
            </div>
      ...
      <!-- End Support Product Form Model-->
      ...
      <div class="support-tool">
         <ul>
            <li class="list-items">
               <div>
                  <img src="https://img.icons8.com/fluency/48/000000/ball-point-pen.png"/>
                  <a class="note" href="">Ý kiến góp ý<i class="fa-solid fa-chevron-right"></i></a>
               </div>
            </li>
            <li class="list-items">
               <div>
                  <img src="https://img.icons8.com/color/30/000000/maintenance.png"/>
                  <a class="note" href="">Liên hệ sửa chữa<i class="fa-solid fa-chevron-right"></i></a>
               </div>
            </li>
            <li class="list-items fix-border">
               <div>
                  <img src="https://img.icons8.com/color/48/000000/noticeboard.png"/>
                  <a class="note" href="">Thanh toán và đăng kí<i class="fa-solid fa-chevron-right"></i></a>
               </div>
            </li>
         </ul>
      </div>
      ...
      <div class="support-search">
         <h1 class="title">Tìm kiếm thông tin hỗ trợ</h1>
         <input type="search" name="" id="" placeholder="Tìm kiếm hỗ trợ">
      </div>
      <!-- End Support Search -->
      ...
      <script src="../../asset/js/support-page.js"></script>
   </body>
</html>